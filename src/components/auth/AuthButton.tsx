...
export default function AuthButton() {
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      {/* TEMPORAIREMENT DÉSACTIVÉ - Sign in with Apple */}
      {/* <button
        onClick={() => signIn('apple')}
        className="flex items-center space-x-2 bg-black text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-gray-800 transition-colors"
      >
